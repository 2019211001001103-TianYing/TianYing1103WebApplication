<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Button.aspx.cs" Inherits="TianYing1103WebApplication.lecture12.Button" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:ImageButton ID="ImageButtonEx" runat="server" CommandName="ImageButtonEx" Height="163px" ImageUrl="~/lecture12/ms.png" OnClick="ButtonEx_Click" OnCommand="ButtonEx_Command" Width="245px" />
        </p>
